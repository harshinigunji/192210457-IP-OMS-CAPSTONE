                    ...
                    <?php foreach ($inventory as $item) : ?>
                        <tr<?php if ($item['quantity'] <= $item['reorder_level']) echo ' class="reorder-alert"'; ?>>
                            ...
                            <td class="action-buttons">
                                <a href="?edit=<?php echo $item['id']; ?>"><button>Edit</button></a>
                                <a href="?delete=<?php echo $item['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button>Delete</button></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
