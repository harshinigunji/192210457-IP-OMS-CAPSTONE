                ...
                <tbody id="orderTableBody">
                    ...
                    <tr>
                        ...
                        <td class="action-buttons">
                            ...
                            <button onclick="deleteOrder(<?php echo $order['id']; ?>)">Delete</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
    ...
    <script>
        ...
        function searchOrders() {
            ...
            const filteredOrders = orders.filter(order => 
                order.id.toString().includes(query) || order.customer_name.toLowerCase().includes(query)
            );
        ...
        function updateStatus(orderId, newStatus) {
            // AJAX request to update status in the backend
